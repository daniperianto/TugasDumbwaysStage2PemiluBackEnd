...
router.post("/paslons/add", uploadMiddleware.handleUpload.bind(uploadMiddleware) , PaslonControllers.create)
router.post("/paslons/:id",AuthenticationMiddlewares.Authentication, uploadMiddleware.handleUpload.bind(uploadMiddleware) , PaslonControllers.update)
...
router.post("/partais/:id",AuthenticationMiddlewares.Authentication, uploadMiddleware.handleUpload.bind(uploadMiddleware), PartaiControllers.update)
